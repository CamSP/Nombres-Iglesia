...
def preview(*args):
    ...
    if end <= 1600:
        ...
        #Se ajusta el tamño del logo (112px) y se dibuja una elipse blanca para que sea un background del logo
    ...
    #Si el tamaño del texto es mayor a 1600px, se utilizarán 2 renglones para mostrar el texto
        ...
        img = im.new('RGBA', (end + 186, 130), (255, 0, 0, 0))
...
def creador(*args):
    ...
    #Se cre un hilo que renderiza la imagen, esto para que el programa no se detenga mientras se renderiza. De esta manera, el usuario puede ir preparando el siguiente nombre/titulo a exportar
